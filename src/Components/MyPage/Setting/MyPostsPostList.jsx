      ...
      <>
        <Grid margin="15vh auto">
          <Grid margin="20px auto" align="center">
            <Text bold size="h5" weight="700">작성된<br />초록톡이 없어요</Text>
          </Grid>
          <Grid margin="auto">
            <NotFound />
          </Grid>
        ...
        <Grid width="100%" padding="0 16px">
          <Button type="square" _onClick={() => { history.push('/addpost'); }}>
            <Text color="#fff" weight="600">초록톡 글쓰기</Text>
          </Button>
        </Grid>
      </>
    )
            ...
            return (
              <Grid key={p.postId} width="100%">
                <Container>
                  ...
                  <Grid margin="8px 0px 16px 0px">
                    <Text color="#262626" size="small" weight="400">{p?.postContent}</Text>
                  </Grid>
                  ...
                  <Grid width="100%" margin="20px 0px 0px 0px" position="relative">
                    <Grid is_flex align="center" >
                      <Grid is_flex align="center">
                        ...
                        <Text margin="0px 8px" size="base" color="#6F6F6F"
                          weight="400">{p?.postLikeCount}</Text>
                      </Grid>
