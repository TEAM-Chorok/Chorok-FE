...
const Questionnaire = (props) => {
    ...
    return (
        <React.Fragment>
          ...
          <QuestionBox 
            border={props.level === "pl01"? "1px solid #0AAF42" : "1px solid #F4F4F4"}
          ...
          <QuestionBox
            border={props.level === "pl02"? "1px solid #0AAF42" : "1px solid #F4F4F4"}
          ...
          <QuestionBox
            border={props.level === "pl03"? "1px solid #0AAF42" : "1px solid #F4F4F4"}
