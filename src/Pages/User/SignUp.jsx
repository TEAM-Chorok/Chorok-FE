        ...
        <Container>
          ...
          <SingUpPage>
              ...
              _onChange={(e)=>{setUserEmail(e.target.value); 
                              idCheck(e.target.value); setOpenResult(false);}} 
              placeholder="이메일" name="signup_id" type="email" 
              display="inline-block"  margin="0px" height="48px" width="100%" padding="0px 0px 0px 20px" border="1px solid #FA4D56" borderRadius="6px"></Input> 
               : 
              // 정상 input
              <Input 
                _onChange={(e)=>{setUserEmail(e.target.value); 
              ...
              _onChange={(e)=>{setPassword(e.target.value); 
                              pwdCheck(e.target.value)}} 
              placeholder="비밀번호" type="password" name="signup_pwd" height="52px" width="100%" padding="0px 0px 0px 20px" border="1px solid #FA4D56" borderRadius="6px"
              margin="0px"></Input>
              <Input 
              _onChange={(e)=>{setPasswordChk(e.target.value); 
                              pwdCheck(e.target.value); }} 
              placeholder="비밀번호 확인" type="password" name="signup_pwd_check" height="52px" width="100%" padding="0px 0px 0px 20px" border="1px solid #FA4D56" borderRadius="6px"></Input> 
              </>
