    ...
    <React.Fragment>
      ...
      <Grid width="100%">
        <AgreementWrap onClick={(e) => checkAgree1(e)}>
          <Grid padding="20px 16px 20px 20px">
            <Text size="small" color="#525252">회원탈퇴를 하셔도 기존에 작성하신 글과 댓글은 <br /> 삭제되지 않습니다.</Text>
          </Grid>
          <Grid margin="0px 4px">
            {agree1 ?
              <CheckedIcon /> :
        ...
        <AgreementWrap onClick={(e) => checkAgree2(e)}>
          <Grid padding="20px">
            <Text size="small" color="#525252">회원탈퇴를 하시면 현재 로그인 된 아이디는 사용하실 수 없으며 모든 계정 정보는 파기됩니다.  </Text>
          </Grid>
          <Grid margin="0px 4px">
            {agree2 ?
              <CheckedIcon /> :
        ...
        <AgreementWrap onClick={(e) => checkAgree3(e)}>
          <Grid padding="20px">
            <Text size="small" color="#525252">회원탈퇴 이후 재가입 시에도 닉네임 및 등록된 <br /> 식물 정보는 복구되지 않습니다.</Text>
          </Grid>
          <Grid margin="0px 4px">
            {agree3 ?
              <CheckedIcon /> :
